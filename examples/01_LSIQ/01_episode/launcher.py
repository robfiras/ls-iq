...
if __name__ == '__main__':
    ...
    launcher = Launcher(exp_name='lsiq_1',
    ...
    envs = ["Ant-v3",
            ...
            "Humanoid-v3",
            "Walker2d-v3"]
    path_to_datasets = "../../00_Datasets/1_episode/"
    expert_data_filenames = ["expert_dataset_Ant-v3_6321.34_1_SAC.npz",
                             "expert_dataset_HalfCheetah-v3_12312.93_1_SAC.npz",
                             "expert_dataset_Hopper-v3_3729.74_1_SAC.npz",
                             "expert_dataset_Humanoid-v3_6335.31_1_SAC.npz",
                             "expert_dataset_Walker2d-v3_5830.37_1_SAC.npz"]
